...
class DwvComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <div id="dwv">
        ...
        <Stack direction="row" spacing={1} padding={4} justifyContent="center">
        ...
        <div id="layerGroup0" className="layerGroup">
          <div style={{display:'flex'}} id="dropBox">
          </div>
        </div>
        ...
        <div><p className="legend">
          <Typography variant="caption">
            ...
            <Link
              ...
              title="CHNsPart on github"
              color="inherit"> CHNsPart
            </Link> 
          </Typography>
        </p></div>
  ...
  showDropbox = (app, show) => {
    ...
    if (show) {
      ...
      box.setAttribute('style', 'justify-content:center;');
      box.setAttribute('style', 'justify-items:center;');
